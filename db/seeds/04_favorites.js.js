exports.seed = function(knex, Promise) {
  return knex('favorites').insert([
    ...
    {id: 21, user_id:1, provider_id:1},
    {id: 22, user_id:2, provider_id:2},
    {id: 23, user_id:3, provider_id:3},
    {id: 24, user_id:4, provider_id:4},
    {id: 25, user_id:5, provider_id:5},
    {id: 26, user_id:6, provider_id:6},
    {id: 27, user_id:7, provider_id:7},
    {id: 28, user_id:8, provider_id:8},
    {id: 29, user_id:9, provider_id:9},
    {id: 30, user_id:10, provider_id:10},
    {id: 31, user_id:1, provider_id:11}
